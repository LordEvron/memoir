...
public class MemoirMediaController {
	...
	public MemoirMediaController(Context c, FrameLayout frameLayout,
			VideoView vv) {
		...
		mContainer = (RelativeLayout) inflater.inflate(
				R.layout.memoir_media_controller, null);
		...
		mPlayButton = (ImageView) mContainer
				.findViewById(R.id.MemoirMediaControllerIV);
		if (mPlayButton != null) {
		...
		mSeekBar = (SeekBar) mContainer
				.findViewById(R.id.MemoirMediaControllerSB);
		if (mSeekBar != null) {
			mSeekBar.setOnSeekBarChangeListener(mSeekListener);
		}

		mStartText = (TextView) mContainer
				.findViewById(R.id.MemoirMediaControllerTV1);
		mEndText = (TextView) mContainer
				.findViewById(R.id.MemoirMediaControllerTV2);
